package uclab.kiosk.qreader.ui;
...
import uclab.kiosk.qreader.QRDecoder;
...
public class QRReader extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("Place the code in front of the camera");
    ...
    private Scene makeUI() {
        ...
        cbAskConfirmation.setText("Ask for confirmation before opening the scanned folder");
        ...
        Platform.runLater(() -> {
            if (cbAskConfirmation.isSelected()) {
                if (!showingDialog) {
                    ...
                    confirmDialog.setHeaderText("Do you want to open the folder: '" + scanResult + "'?");

                    ButtonType yes = new ButtonType("Open");
    ...
    private void openFolderInExplorer(String url) {
        ...
        if (!directory.isDirectory()) {
            ...
            errorDialog.setHeaderText("The directory: '" + url + "', does not exist.");
